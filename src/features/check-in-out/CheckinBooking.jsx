...
function CheckinBooking() {
  ...
  const { breakfastPrice,isPending: isLoadingBreakfast } = useSettings();
  ...
  const finalTotalPrice = getBreakfast
  ...
  if (isPending || isLoadingBreakfast) return <Spinner />;
  ...
  return (
    <>
      ...
      {!hasBreakfast && (
        <Box>
          <Checkbox
            checked={getBreakfast}
            id={"breakfast"}
            onChange={() => {
              setBreakfast((curr) => !curr);
